...
const purgeCache = (bucketId, DOTOKEN, projectName) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('purging cache');
    const res = yield node_fetch_1.default(`https://api.digitalocean.com/v2/cdn/endpoints/${bucketId}/cache`, {
        method: 'DELETE',
        headers: {
